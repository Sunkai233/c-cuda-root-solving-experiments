...
"NRELOffshrBsline5MW_Onshore_AeroDyn_noUA_debug.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
         60   SttsTime        - Amount of time between screen status messages (s)
